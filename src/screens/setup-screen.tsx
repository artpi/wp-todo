		...
		>
			...
			>
					...
					{ ! connecting && ! data.username && (
						<>
							...
							{ ! wpURL && (
								<>
									<Text margin={ '6' }>
										WP TODO requires a WordPress
										installation. You don't have a WordPress
										yet?
									</Text>
									<LinkButton
								...
								<>
									...
									{ wpURL && (
										<Link
											...
											href={
												normalizeUrl( wpURL ) +
												`/wp-admin/authorize-application.php?app_name=wp-todo`
											}
										>
				...
				{ ! connecting && data.post_types.length > 0 && (
					<>
						{ data.connected && data.site_title && (
							<Heading p={ 6 } size="md">
						...
						{ posPlugin === 0 && (
							<>
								...
								<Text p={ 6 }>
									WP TODO can work with any post type and
									taxonomy. However, I recommend using the
									"Personal OS" plugin to manage your TODOs.
								</Text>
								<Text p={ 6 }>
									You can also use existing Custom Post Types
									and taxonomies without any additional
									plugins.
								</Text>
						...
						{ posPlugin === 2 && (
							<>
								...
								>
									Which post type holds your TODOs?
								</Heading>
								<Picker
									style={ pickerStyle }
								...
								{ data.post_type.length > 0 &&
									data.taxonomies &&
									data.post_types.find(
										( type ) => type.slug === data.post_type
									) &&
									data.post_types.find(
										( type ) => type.slug === data.post_type
									).taxonomies.length > 0 && (
